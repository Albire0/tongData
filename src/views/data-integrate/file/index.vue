<template>
	<div v-show="ifshow">
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" max-height="calc(100vh - 400px )" @selection-change="selectionChangeHandle">
			...
			<el-table-column show-overflow-tooltip prop="name" label="名称" header-align="center"></el-table-column>
			<fast-table-org-column prop="orgId" label="所属机构" header-align="center"></fast-table-org-column>
			<el-table-column show-overflow-tooltip prop="fileCategoryId" label="所属分组" header-align="center">{{state.path}}</el-table-column>
			<el-table-column prop="type" label="文件类型" header-align="center"></el-table-column>
			...
			<el-table-column prop="size" label="文件大小" header-align="center">
				<template #default="scope">
			...
			<fast-creator-column prop="creator" label="创建者" header-align="center"></fast-creator-column>

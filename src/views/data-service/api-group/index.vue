<template>
	<el-card @click="OptionCardClose($event)">
			...
			<div class="leftBox">
				<el-scrollbar>
					<div style="height: 100%" class="apiGroupTreeDiv">
						...
						<div v-if="!props.ifAuth"><el-button type="primary" @click="appendCatalogueRoot">添加根目录</el-button><br /><br /></div>
						<el-tree
		...
		>
			<el-button v-show="ckRightOptionData.optionData.type == '1'" class="option-card-button" @click="appendCatalogueChild">添加子目录</el-button>
			<el-button class="option-card-button" @click="renameCatalogue">重命名</el-button>

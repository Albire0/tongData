	...
	<el-card body-style="height: calc(100vh - 170px )" @click="OptionCardClose($event)">
		<div>
			<SideLayout class="fp-content" left-title="数据表" right-title="表信息">
					...
					<div>
						<el-scrollbar style="height: calc(100vh - 220px)">
							<div style="height: 100%" class="DataTableTreeDiv">
								...
								<div><el-button type="primary" @click="createTable">建表</el-button><br /><br /></div>
								<el-tree
									ref="treeRef"
									:data="treeList"
									default-expand-all
				...
				<template #right>
					<div v-show="infoView" v-loading="detailLoading" class="data-table-right">
							...
							<el-tab-pane label="SQL 控制台" name="sqlConsole">
								<div style="padding-top: 5px">
									...
									<el-tooltip class="box-item" effect="dark" content="执行" placement="top-end">
										<el-button :loading="executeSqlButton" text @click="executeSql()"><img src="@/assets/run.png" /></el-button>
									</el-tooltip>
								</div>
								<div style="height: calc(100vh - 650px); padding-top: 5px">
									<SqlStudio id="dataTableSqlConsoleId" ref="sqlStudioRef" height-all></SqlStudio>
								</div>
					...
					<el-empty v-if="currentNode.type != 3" description="请选择左侧目录 获取详情" />
				</template>
			</SideLayout>
		</div>
		<el-dialog
		...
		>
			<el-button class="option-card-button" @click="getDbInfo">查看</el-button>
		</div>
	</el-card>
</template>

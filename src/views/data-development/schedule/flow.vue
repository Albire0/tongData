<template>
	<el-card>
		<div class="flowBox" style="height: 100%">
			<div v-loading="saveLoading" class="flowTopBox">
				<div class="leftFlowBox">
					<el-scrollbar>
						<div style="height: 100%" class="flowdiv">
							<el-input v-model="filterCatalogueText" placeholder="search" /><br /><br />
							<el-tree ref="catalogueTreeRef" :data="catalogueTreeList" default-expand-all node-key="id" :filter-node-method="filterNode">
								<template #default="{ node, data }">
									...
									<div v-else class="flow-tree-drag—node" @mousedown="startDrag(data)">
										<span>
				...
				<div class="rightFlowBox">
					<div id="flowContainer" ref="flowContainer" style="height: 100%; width: 100%" @dragover="allowDropOver"></div>
				</div>
			</div>
			<!-- 上下侧边 -->
			<div v-show="runFlag" title="上下侧边栏" class="flowBottomResize"></div>
			<div v-show="runFlag" class="flowBottomBox">
	...
	<!-- 下载流程图 -->
	<div v-show="false" id="snapshotDownloadId"></div>
		...
		<template #default>
			<el-form ref="nodeDataFormRef" :model="nodeDataForm" :rules="nodeDataRules" label-width="100px" @keyup.enter="nodeSubmit()">
				...
				<el-form-item label="作业类型" prop="properties.taskTypeVal" label-width="auto">
					<el-input v-model="nodeDataForm.properties.taskTypeVal" disabled placeholder="作业类型"></el-input>
				</el-form-item>
				...
				<el-form-item label="备注" prop="properties.note" label-width="auto">
					<el-input v-model="nodeDataForm.properties.note" :rows="2" type="textarea" placeholder="备注"></el-input>
				</el-form-item>
			</el-form>
		</template>
		<template #footer>
	...
	<el-dialog v-model="configVisible" title="调度配置" @keyup.enter="scheduleSubmit(false)">
		<el-form ref="scheduleFormRef" :model="scheduleForm" :rules="scheduleRules" label-width="100px">
			...
			<el-form-item v-if="scheduleForm.ifCycle == '1'" label="cron表达式" prop="cron" label-width="auto">
				<el-input v-model="scheduleForm.cron" placeholder="cron表达式"></el-input>
        <el-button v-if="scheduleForm.ifCycle == '1'" type="primary" style="margin-top: 1rem" @click="dialogCronVisible = true"
        >配置Cron表达式</el-button
        >
			...
			<el-form-item label="备注" prop="note" label-width="auto">
				<el-input v-model="scheduleForm.note" :rows="2" type="textarea" placeholder="备注"></el-input>
			</el-form-item>
		</el-form>

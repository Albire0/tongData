<template>
	<div class="crontab">
			...
			<el-tabs type="border-card" stretch>
					...
					<div class="tabBody">
						...
						<el-row>
							<el-radio v-model="second.cronEvery" label="4"
								...
								<el-input-number v-model="second.rangeStart" size="small" :min="0" :max="59"></el-input-number>
					...
					<div class="tabBody">
						...
						<el-row>
							<el-radio v-model="minute.cronEvery" label="4"
								...
								<el-input-number v-model="minute.rangeStart" size="small" :min="0" :max="59"></el-input-number>
				...
				<el-tab-pane>
					...
					<div class="tabBody">
						...
						<el-row>
							<el-radio v-model="year.cronEvery" label="4"
								...
								<el-input-number
									...
									:min="2018"
									:max="2118"
									@change="yearValidation(year.rangeStart, year.rangeEnd)"
								></el-input-number>
								{{ text.Year.cycle[1] }}
								<el-input-number
						...
						<p v-if="!isYearValid" style="color: #ad2929">
							<el-icon><WarningFilled /></el-icon> 开始年份不能大于结束年份
						</p>
					</div>
				</el-tab-pane>
			</el-tabs>
		...
		<div class="bottom">
			<p class="value" style="margin-bottom: 10px">{{ cron }}</p>
...
export default defineComponent({
	...
	methods: {
		...
		yearValidation(start: string, end: string) {
